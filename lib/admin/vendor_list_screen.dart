...
class _VendorListScreenState extends State<VendorListScreen> {
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: imageBytes == null
              ? Icon(Icons.store, color: AppColors.deepBlack, size: 30)
              : null,
        ),
        title: Row(
          children: [
        ...
        trailing: PopupMenuButton<String>(
          ...
          onSelected: (value) {
            if (value == 'view') {
              _viewVendorDetails(vendorId, name, email, shopName, phone, isAvailable);
            } else if (value == 'delete') {
              _deleteVendor(vendorId, name);
            } else if (value == 'toggle') {
              _toggleAvailability(vendorId, isAvailable);
            }
          },
          itemBuilder: (context) => [
            PopupMenuItem(
  ...
  void _viewVendorDetails(String vendorId, String name, String email, String shopName,
      String phone, bool isAvailable) {
    showDialog(
      context: context,
  ...
  void _toggleAvailability(String vendorId, bool currentStatus) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            !currentStatus ? 'Vendor is now Available' : 'Vendor has been Blocked',
          ),
          backgroundColor: AppColors.richGold,
        ),
      );
  ...
  void _deleteVendor(String vendorId, String name) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: AppColors.cardBlack,
