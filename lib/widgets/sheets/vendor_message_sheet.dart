...
class VendorMessageSheet extends StatefulWidget {
  final String vendorId;

  const VendorMessageSheet({
    super.key,
    required this.vendorId,
  });

  @override
  State<VendorMessageSheet> createState() => _VendorMessageSheetState();
}

class _VendorMessageSheetState extends State<VendorMessageSheet> {
  @override
  void initState() {
    super.initState();
    _markMessagesAsRead();
  ...
  Future<void> _markMessagesAsRead() async {
    try {
      final query = FirebaseFirestore.instance
          ...
          .where('vendorMessageRead', isEqualTo: false);
      ...
      if (kDebugMode) {
        debugPrint('Marked ${snapshot.docs.length} vendor messages as read');
      }
    } catch (e) {
      if (kDebugMode) {
        debugPrint('Error marking vendor messages read: $e');
      }
    }
  }
  ...
  Widget _buildMessageItem(QueryDocumentSnapshot doc) {
    ...
    final isRead = data['vendorMessageRead'] == true;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(
                      paymentMethod.toLowerCase().contains('easypaisa') ||
